...
def menuEventos():
    ...
    tk.Label(eventos, text="ABM Bomberos", foreground="#fff", background="#333", font=('arial', 20)).place(x=680, y=200)
        ...
        def guardar():
            try:
                ...
                conexion = mysql.connector.connect(
                    user="root", password="", host="127.0.0.1", database="bomberos"
                )
...
tk.Button(root, text="Eventos", background="#FFA82B", width=20, height=2, command=menuEventos).place(x=650, y=400)
