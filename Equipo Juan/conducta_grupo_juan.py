...
def menuConducta():
    ...
    tk.Button(conducta, text="Menú principal", background="#FFA82B", width=20, height=2, command=conducta.destroy).place(x=700, y=550)